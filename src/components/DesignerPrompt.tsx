      ...
      <form onSubmit={(e) => handleSubmit(e)}>
        <div className="flex flex-col gap-4 sm:flex sm:flex-row">
          <div className="w-full sm:w-1/2	">
            <div className="text-[#585E70] font-bold">Design Category</div>
            <Select
              styles={{
                control: (baseStyles) => ({
                  ...baseStyles,
                ...
                singleValue: (baseStyles) => ({
                  ...
                  backgroundColor: '#131C3C', // Background color for the selected value
                }),
                option: (baseStyles, state) => ({
                  ...baseStyles,
                  color: state.isFocused ? '#fff' : '#ffffff', // Text color for options
                  backgroundColor: state.isFocused ? '#1EB1DB' : '#131C3C',
                  ':hover': {
          ...
          <div className="w-full sm:w-1/2">
            <div className="text-[#585E70] font-bold">Artist Inspiration</div>
            <Select
              styles={{
                control: (baseStyles) => ({
                  ...baseStyles,
        ...
        <div className="text-[#585E70] font-bold text-center max-w-2xl	mx-auto">
        ...
        <div className="flex flex-col gap-4 sm:flex sm:flex-row">
          <div className="w-full sm:w-1/2">
            <div className="text-[#585E70] font-bold">Ice Cream Flavor</div>
            <Select
              styles={{
                control: (baseStyles) => ({
                  ...baseStyles,
          ...
          <div className="w-full sm:w-1/2">
            <div className="text-[#585E70] font-bold">Candies</div>
            <Select
              styles={{
                control: (baseStyles) => ({
                  ...baseStyles,
        ...
        <div className="flex flex-col gap-4 sm:flex sm:flex-row">
          <div className="w-full sm:w-1/2">
            <div className="text-[#585E70] font-bold">Spices</div>
            <Select
              styles={{
                control: (baseStyles) => ({
                  ...baseStyles,
          ...
          <div className="w-full sm:w-1/2 color-section">
            <div className="text-[#585E70] font-bold">Colors</div>
            <Select
              styles={{
                control: (baseStyles) => ({
                  ...baseStyles,
          ...
          <div id="response" className="!my-[0rem]">
            ...
            <div className="bg-[#293A74] p-4 rounded-lg">
              ...
              <div className="download_option flex gap-4 mt-4">
                <div className="copy_icon p-2 w-9 h-9 border border-[#4863BE] rounded-[10px] text-center flex justify-center items-center cursor-pointer hover:bg-[#B6F09C]" onClick={() => copyImageToClipboard(summary)}>
                ...
                <div className="download_icon p-2 w-9 h-9 border border-[#4863BE] rounded-[10px] text-center flex justify-center items-center cursor-pointer hover:bg-[#B6F09C]" onClick={() => downloadImage(summary)}>
