            ...
            <a href={summary} target="_blank" rel="noreferrer">
              <div className="bg-[#293A74] p-4 rounded-lg">
                ...
                <div className="download_option flex gap-4 mt-4">
                  <div className="copy_icon p-2 w-9 h-9 border border-[#4863BE] rounded-[10px] text-center flex justify-center items-center cursor-pointer">
                  ...
                  <div className="share_icon p-2 w-9 h-9 border border-[#4863BE] rounded-[10px] text-center flex justify-center items-center cursor-pointer">
                  ...
                  <div className="download_icon p-2 w-9 h-9 border border-[#4863BE] rounded-[10px] text-center flex justify-center items-center cursor-pointer">
                    <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
