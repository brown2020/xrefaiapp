      ...
      <form onSubmit={(e) => handleSubmit(e)}>
        <div className="flex flex-col gap-4 sm:flex sm:flex-row">
          <div className="w-full sm:w-1/2	">
            <div className="text-[#041D34] font-semibold">Design Category</div>
            <Select
              styles={{
                control: (baseStyles) => ({
                  ...baseStyles,
                ...
                placeholder: (baseStyles) => ({
                  ...baseStyles,
                  color: '#BBBEC9', // Color of the placeholder
                }),
                singleValue: (baseStyles) => ({
                  ...baseStyles,
                  color: '#0B3C68', // Text color for the selected value
                  backgroundColor: '#F5F5F5', // Background color for the selected value
                }),
                option: (baseStyles, state) => ({
                  ...baseStyles,
                  color: state.isFocused ? '#fff' : '#0B3C68', // Text color for options
          ...
          <div className="w-full sm:w-1/2">
            <div className="text-[#041D34] font-semibold">Artist Inspiration</div>
            <Select
              styles={{
                control: (baseStyles) => ({
                  ...baseStyles,
        ...
        <div className="text-[#041D34] font-semibold text-center max-w-2xl	mx-auto">
        ...
        <div className="flex flex-col gap-4 sm:flex sm:flex-row">
          <div className="w-full sm:w-1/2">
            <div className="text-[#041D34] font-semibold">Ice Cream Flavor</div>
            <Select
              styles={{
                control: (baseStyles) => ({
                  ...baseStyles,
          ...
          <div className="w-full sm:w-1/2">
            <div className="text-[#041D34] font-semibold">Candies</div>
            <Select
              styles={{
                control: (baseStyles) => ({
                  ...baseStyles,
        ...
        <div className="flex flex-col gap-4 sm:flex sm:flex-row">
          <div className="w-full sm:w-1/2">
            <div className="text-[#041D34] font-semibold">Spices</div>
            <Select
              styles={{
                control: (baseStyles) => ({
                  ...baseStyles,
          ...
          <div className="w-full sm:w-1/2 color-section">
            <div className="text-[#041D34] font-semibold">Colors</div>
            <Select
              styles={{
                control: (baseStyles) => ({
                  ...baseStyles,
          ...
          <div id="response" className="!my-[0rem]">
            ...
            <div className="bg-[#E7EAEF] p-4 rounded-lg">
              ...
              <div className="download_option flex gap-4 mt-4">
                <div className="copy_icon p-2 w-9 h-9 border border-[#A3AEC0] rounded-[10px] text-center flex justify-center items-center cursor-pointer hover:bg-[#83A873]" onClick={() => copyImageToClipboard(summary)}>
                ...
                <div className="share_icon hidden p-2 w-9 h-9 border border-[#4863BE] rounded-[10px] text-center justify-center items-center cursor-pointer hover:bg-[#B6F09C]" onClick={() => shareImage()}>
                ...
                <div className="download_icon p-2 w-9 h-9 border border-[#A3AEC0] rounded-[10px] text-center flex justify-center items-center cursor-pointer hover:bg-[#0A0F20]" onClick={() => downloadImage(summary)}>
