      ...
      svg: (
        <>
          <svg
            ...
            viewBox="0 0 452 452"
            className="svg-inline--fa fa-circle-notch w-4 h-4"
          >
            <path
              fill="currentColor"
              d="M449.94,193.74c-0.55,25.11-0.29,50.31-1.81,75.4c-3.18,52.44-48.01,99.5-100.22,104.77
      ...
      svg: (
        <>
          ...
          >
            <path
              fill="currentColor"
              d="M105.5,209.95c-18,0-36,0.05-53.99-0.01c-28.72-0.09-49.46-20.75-49.52-49.42c-0.07-36.32-0.06-72.64,0-108.96
        ...
        c-36.35-0.03-72.69-0.03-109.04,0c-11.07,0.01-17.58,6.6-17.59,17.78C33.97,69.71,33.99,87.71,33.99,105.71z"
            ...
            <path
              fill="currentColor"
              d="M346.18,1.91c18.16,0,36.33-0.05,54.49,0.01c28.73,0.09,49.4,20.72,49.46,49.47c0.08,36.32,0.07,72.64,0,108.96
        ...
        c-0.03,36.34-0.03,72.68,0,109.01c0.01,11.1,6.58,17.6,17.76,17.62C309.85,177.97,327.86,177.94,345.87,177.94z"
            ...
            <path
              fill="currentColor"
              d="M106.17,241.96c18,0,36-0.03,53.99,0.01c29.33,0.06,49.84,20.63,49.88,50.06c0.04,35.99,0.04,71.98,0,107.96
        ...
        c36.35,0.03,72.69,0.03,109.04,0c11.16-0.01,17.61-6.52,17.63-17.75C178.07,382.23,178.04,364.23,178.04,346.23z"
            ...
            <path
              fill="currentColor"
              d="M346.1,241.96c18.16,0,36.33-0.04,54.49,0.01c28.76,0.09,49.48,20.68,49.54,49.38c0.08,36.49,0.09,72.98,0,109.46
      ...
      svg: (
        <>
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 452 452"
            className="svg-inline--fa fa-custom-icon w-4 h-4"
          >
            <path
              fill="currentColor"
              d="M107.84,214.39c0-2.06,0-3.85,0-5.64c0-54.84-0.01-109.68,0-164.52c0-26.05,16.36-42.35,42.49-42.35
        ...
        C361.94,61.66,361.94,75.34,361.94,89.06z"
            ...
            <path
              fill="currentColor"
              d="M278.21,187.45c-31.5,0-63.01,0.05-94.51-0.03c-11.34-0.03-18.01-9.96-13.04-19.22
        ...
        c-2.85,5.55-7.69,7.36-13.67,7.35C341.22,187.42,309.72,187.45,278.21,187.45z"
            ...
            <path
              fill="currentColor"
              d="M134.02,318.81c7.53,0,14.34-0.05,21.14,0.01c8.21,0.07,13.93,5.55,13.86,13.16
      ...
      svg: (
        <>
          ...
          >
            <path
              fill="currentColor"
              d="M450.14,225.92c0.02,123.84-100.32,224.12-224.17,224.05C102.06,449.89,1.82,349.52,1.99,225.72
    ...
    <div className="container mx-auto bg-[#ffffff] sticky top-0 z-30 text-gray-700  px-4 py-4">
      ...
      {showMenu && (
        <div className="relative flex w-full h-full sm:hidden">
          <div className="fixed top-0 right-0 z-40 w-full h-screen bg-black/50" />
          {sideBar}
        </div>
      )}
    </div>
