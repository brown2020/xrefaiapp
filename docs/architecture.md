...
| Payments | Stripe return-page confirm route (`/api/billing/confirm`) / IAP confirm action; no Stripe webhook | Firestore payments + credits ledger | account UI reload |
